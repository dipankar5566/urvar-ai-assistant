...
export async function runRdProductAgent(userMessage, history = [], tracker = null) {
  ...
  try {
    ...
    catalogueSection = useful
      ...
      : `\n\n## Urvar Product Catalogue\nUrvar sells ONLY these 8 products: ${CATALOGUE_PRODUCTS}. When advising farmers, you may ONLY recommend products from this list — never suggest any other fertilizer, brand, or product Urvar does not sell.`;
  } catch {
    catalogueSection = `\n\n## Urvar Product Catalogue\nUrvar sells ONLY these 8 products: ${CATALOGUE_PRODUCTS}. When advising farmers, you may ONLY recommend products from this list — never suggest any other fertilizer, brand, or product Urvar does not sell.`;
  }
